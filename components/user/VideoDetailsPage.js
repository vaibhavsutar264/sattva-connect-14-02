      ...
      axios
        ...
        .then((res) => {
          ...
          this.setState({
            ...
            completeStatus: res.data.markDone,
  ...
  changeCompletedStatus = (e) => {
    ...
    if (!this.state.completeStatus) {
      axios
        ...
        .then((res) => {
          this.setState({ completeStatus: true, loading: false });
        })
        .catch((error) => {
          window.scrollTo(0, 0);
          this.setState({
      ...
      axios
        ...
        .then((res) => {
          this.setState({ completeStatus: false, loading: false });
        })
        .catch((error) => {
          window.scrollTo(0, 0);
          this.setState({
                    ...
                    <div className='media-header'>
                      <div>
                        {this.state.access === false ? (
                          <div
                            className='alert alert-danger col-sm-8'
                            role='alert'
                          >
                        ...
                        {this.state.showSubscriptionError && (
                          <div
                            ...
                            role='alert'
                          >
                            <p>Your subscription is expired. Please renew it.</p>
                          </div>
                        )}
                        ...
                        <h4 className='media-media-title revamp-videotitle mb-0'>
                        ...
                        <div className='meta_info mt-0 mb-1'>
                          ...
                          <span className='duration'>
                            {' '}
                            Hari Om:
                            <span className='revamp-signature'>{this.state.hariom.length}</span>
                          </span>
                        </div>

                      </div>
                      <>
                        <div className='media-btns  media-flex text-right my-4 video-btn-desk'>
                          <a
                            title={
                          ...
                          <a
                            title={
                              this.state.completeStatus === false
                                ? 'Mark as complete'
                        ...
                        <div className='media-btns  media-flex text-right my-4 video-btn-mobile'>
                          <a
                            title={
                              this.state.classStatus === false
                                ? 'Add to My Classes'
                              ...
                              <div class='pop-img'>
                                {item.comment !== null ? (
                                  ...
                                  <a
                                    data-html={true}
                                    data-for='custom-color-no-arrow'
                                    data-tip={item.user?.first_name && item.user?.last_name ?
                                      `<h6>
                                      ${item.user?.first_name}
                                      ${item.user?.last_name}
                                      </h6>` : `<h6>Sattva User</h6>`
                                    }
                                  >
                                    <img
                                      src={userProfilePath(
                                        item.user?.profile_pic ? item.user.profile_pic : 'profpic.png'
                                      )}
                                    />
                                  </a>
                                )}
