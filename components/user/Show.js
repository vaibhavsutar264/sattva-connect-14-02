            ...
            <section className='inner-banner about-banner blog-inner-bg' style={{ backgroundImage: `url(${post.inner_image})`, }}>
                <div className='container text-center text-white' style={{ display: 'flex', justifyContent: 'center' }}>
                    <div style={{ display: 'flex', alignItems: 'end', flexDirection: 'column' }}>
                        <h1 className='revamp-signature-heading mb-3'>{post.title}</h1>
                        <p className=''>by {post.author}</p>
                        {/* <h2 className='sp-posttitle animated-two fadeInUp sp-animation-2'></h2> */}
                    </div>
                </div>
            </section>
            <section className='sec sec-blog blog-outer-post blog_innerPg light-purplebg'>
                <div class="right_member_plan_bg">
                    <div className='blog_outer login_blog'>
                        <div className="row">
                            <div className='col-md-12 col text-right mb-4'>
                                <Link href='/user/blog'>
                                ...
                                <div className="card card-course">
                                    ...
                                    <div className="card-course-content">
                                        <div className="blog-headings">
                                            <h6 className="react-reveal courseHeading revamp-blog-title">{post.title}</h6>
                                        </div>
                                        <div class="course-paragraph revamp-para-small"
                                        ...
                                        <div className="card-ft">
                                            ...
                                            <h5>{`Publish date - ${moment(post.schdedule_date).format("DD-MM-YYYY")}`}</h5>
                                        </div>

                                        <div className="card-ft-icon mt-3">
                                            <FacebookShareButton
                                                url={Constants.SITE_URL + `/user/blog/${post.slug}`}
                                                quote={post.title}
