      ...
      <>
        ...
        <div className='card p-4 d-block'>
          <div className='customer-support p-0'>
            <h4 className='revamp-subtitle'>Course Purchase</h4>
            <p className='revamp-para'>
              If you are a member of Sattva Connect, then please click here -{' '}
              <Link href='/login'>
            ...
            >
              <div className=' detail-form '>
                ...
                <div className=' control-group revamp-form-field alt alt'>
                  <label
                    id='address-lbl'
                    htmlFor='address'
                    className=' required'
                ...
                <div
                  className='control-group revamp-form-field '
                ...
                >
                  ...
                  <div className='controls'>
                    <select
                      className='input-field select-style'
