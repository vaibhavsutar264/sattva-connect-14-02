...
class Home extends Component {
  ...
  render() {
    ...
    // const affiliateUrlId = this.props.match.params.affiliateId;
    return (
          ...
          <div className='container'>
            ...
            <Reveal effect='fadeInUp'>
              ...
              <p className='mb-3'>
                ...
                ten written wisdom chapters, the ten downloadable audio
                meditation practices, and ten deeply insightful full talks with
                Himalayan Master Anand Mehrotra... That's 10 half hour episodes,
                then 5 more Hours of Wisdom filmed during the journey but not
                shown in the series, Ten written chapters, and Ten 25-minute
                audio meditations...
              </p>
                    ...
                    <li>
                      <div>
                        <h6>
                          ...
                          <span>
                            filmed during the series (5 + Hours) by Anand
                            Mehrotra
                          </span>
                        </h6>
                ...
                <Reveal effect='fadeInUp'>
                  ...
                  <ul className='list-unstyled'>
                    <li>
                      <div>
                        <h6>
                          Find Freedom from the stories that hold us back.{' '}
                        </h6>
                      </div>
                    </li>
                    <li>
        ...
        <div className='secTry'>
          <div className='container'>
            <div className='row'>
              <div className='col-xl-5 col-lg-6 col-md-7 col-sm-8 col-12'>
                <Reveal effect='fadeInUp'>
                  <h3 className='secHeadings'>TRY FOR FREE</h3>
                  <p>
                    With Just an Email Registration you can enjoy the First
                    Three Lessons of Ten:
                  </p>
                  <ul className='list-unstyled'>
              ...
              <div className='row'>
                  ...
                  <AccordionItem>
                    ...
                    <AccordionItemPanel>
                      <p>
                        ...
                        much like nature, we must make big jumps in our
                        evolution. For some, just riding a motorcycle or being
                        in India will force this huge leap!{' '}
                      </p>
                    </AccordionItemPanel>
                  </AccordionItem>
                  <AccordionItem>
                    ...
                    <AccordionItemPanel>
                      <p>
                        ...
                        stories come in and try to pull us back. The stories
                        will try to justify a trigger or fear rather than
                        liberate us from that. We must watch out for these as we
                        leave Rishikesh into torrential rains…
                      </p>
                    </AccordionItemPanel>
                  </AccordionItem>
                  <AccordionItem>
                    ...
                    <AccordionItemPanel>
                      <p>
                        ...
                        that reveals we do not need to negate the individual,
                        but rather find a deeper awareness of the Ego patterns
                        and rise above them to freedom.
                      </p>
                    </AccordionItemPanel>
                  </AccordionItem>
                  <AccordionItem>
                    ...
                    <AccordionItemPanel>
                      <p>
                        ...
                        ready to take arms and lash out when threatened. Do not
                        be so ignorant to think we don’t have it. We must become
                  ...
                  <AccordionItem>
                    ...
                    <AccordionItemPanel>
                      <p>
                        ...
                        them.” We experience this Freedom in the space and gap
                        at the magical peak of Tungnath, high in the Himalayas
                        where we learn the power in the gap and how to not get
                        pulled into the sting of the scorpion.
                      </p>
                    </AccordionItemPanel>
                  </AccordionItem>
                </div>
                <div className='col-md-6'>
                  <AccordionItem>
                    ...
                    <AccordionItemPanel>
                      <p>
                        The true masters know that we must sustain our practice
                        or fall prey to arrogance. Relationship is a perfect
                        place to constantly grow, in fact the focus should be on
                        evolution, not what one can give. We explore this at
                        Badrinath Temple with Jeff and Jen on the verge of a
                        break through.
                      </p>
                    </AccordionItemPanel>
                  </AccordionItem>
                  <AccordionItem>
                    ...
                    <AccordionItemPanel>
                      <p>
                        We often misunderstand true power as power over
                        something or someone. Anand explains to Ryan that we
                        often can fear stepping into our true power, afraid of
                        the responsibility it will bring… but we must step into
                        our power, the power we have to control our freedom is a
                        birth right we can’t shy away from, especially here in
                        the Hidden Valley of the Flowers.
                      </p>
                    </AccordionItemPanel>
                  </AccordionItem>
                  <AccordionItem>
                    ...
                    <AccordionItemPanel>
                      <p>
                        ...
                        honor service. It is through giving that we start to
                        send the message we are bigger than ourselves. And also
                        as we become freer, we are more available to be truly of
                        help.
                      </p>
                    </AccordionItemPanel>
                  </AccordionItem>
                  <AccordionItem>
                    ...
                    <AccordionItemPanel>
                      <p>
                        As Anand says, “Forgive yourself 10 times a day, but
                        hold yourself to high principles.” Principles will not
                        only set you free, but will set those around you free.
                        As we are returning from the peaks, we must keep growing
                        and practicing and integrating.
                      </p>
                    </AccordionItemPanel>
                  </AccordionItem>
                  <AccordionItem>
                    <AccordionItemHeading>
                      <AccordionItemButton>
                        <span>
                          Lesson 10: Freedom IS EXPANSIVE. WE ARE GREATER THAN
                          WE KNOW
                        </span>{' '}
                        <img src={'/images/roadtodharma/next2.svg'} />
                      </AccordionItemButton>
                    ...
                    <AccordionItemPanel>
                      <p>
                        ...
                        freedom includes space for this mystery and unraveling
                        of a you that’s beyond your wildest dream or
                        understanding. Just having space for this mystery is a
                        key to freedom.{' '}
                      </p>
                    </AccordionItemPanel>
                  </AccordionItem>
                ...
                <Reveal effect='fadeInUp'>
                  <div>
                    ...
                    <p>
                      ...
                      physical and mental. Despite a vedic prophecy that he
                      would die in an accident in his late twenties, he took a
                      journey on motorcycles over the highest road in the world
                      (18,00ft.) Having faced his own death head on, Anand now
                      invites a diverse group of adventurers to join him on a
                      harrowing journey of motorcycling sheer cliff roads and
                      hiking trails deep into the Himalayas to experience a
                      powerful and unique pilgrimage.
                    </p>
                    <p>
                ...
                <Reveal effect='fadeInUp'>
                  <div>
                    ...
                    <p>
                      ...
                      places and lengths to follow heroic stories that empower
                      us. Adam is known for his feature documentaries THE{' '}
                      <span className='textBold'>
                      ...
                      documentary <span className='textBold'>HEAL (2017)</span>{' '}
                      is a #1 Best-Selling Documentary on iTunes and empowers us
                      to change one’s beliefs, thoughts, emotions and
                      perceptions in order to help the body heal (NETFLIX 2019.)
                    </p>
                    <p>
                      Adam is the creator and director of{' '}
                      <span className='textBold'>
                        THE ROAD TO DHARMA (2020)
                      </span>{' '}
                      series. He is the writer and the author of the course
                      chapters and audio meditations. He is a certified Master
                      Sattva Yoga Teacher, was a founder of SattvaYoga LA and
                      has been teaching yoga and meditation in Los Angeles for
                      over 10 years.{' '}
                    </p>
                    <p className='text-center mb-0'>
        ...
        <footer>
          <div className='container'>
            ...
            <ul class='list-unstyled'>
              <li>
                <a href='/buywop/NDg=/MTY='>BUY NOW</a>
              </li>
            </ul>
            <p>
