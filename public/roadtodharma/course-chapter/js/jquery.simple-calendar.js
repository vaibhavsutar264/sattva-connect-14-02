...
; (function ($, window, document, undefined) {
    ...
    $.extend(Plugin.prototype, {
        init: function () {
            ...
            var header = $('<header>' +
                '<h2 class="month"></h2>' +
                '<a class="btn btn-prev" href="#"><i class="fas fa-chevron-left"></i></a>' +
                '<a class="btn btn-next" href="#"><i class="fas fa-chevron-right"></i></a>' +
                '</header>');
        ...
        buildCalendar: function (fromDate, calendar) {
            ...
            var eventContainer = $('<div class="event-container"> <div class="row"> <div class="col-sm-6"> <div class="event-card"> <div class="event-left"> <img src="../img/anandji.jpg"> </div><div class="event-right"> <h6>Master Anand Mehrotra</h6> <div class="event_info"> <p class="event-date">Mar 01, 2019</p><p class="title">At 8:00pm IST (Rishikesh, India)</p></div></div></div></div><div class="col-sm-6"> <div class="event-card"> <div class="event-left"> <img src="../img/saraswati-livestream.jpg"> </div><div class="event-right"> <h6>Saraswati</h6> <div class="event_info"> <p class="event-date">Mar 01, 2019</p><p class="title">At 8:00pm IST (Rishikesh, India)</p></div></div></div></div></div><a href="#" class="close"></div>');
