...
class BuyCourseFormLanguage extends Component {
  constructor(props) {
    super(props);
      ...
      <>
        ...
        <div className='card p-4 d-block'>
          <div className='customer-support p-0'>
            <h4>Registracija</h4>
            <p>
              Jei jau esate Sattvaconnect narys, spustelėkite čia -{' '}
              <Link href='/login'>
                <a className='loginLink'>Prisijunk dabar</a>
              </Link>
            </p>
            ...
            {this.state.minDonationStatus == false && (
              <div
                ...
                role='alert'
              >
                <p>Minimali aukos suma yra 10 USD.</p>
              </div>
            )}
            {this.state.confirmEmailError == true && (
              <div
                ...
                role='alert'
              >
                <p>Elektroninis paštas nesutampa.</p>
              </div>
            )}
            ...
            {this.state.emailAvailability == false && (
              <div
                ...
                role='alert'
              >
                <p>El. Paštas jau užregistruotas, Prisijunkite.</p>
              </div>
            )}
            {this.state.usenameAvailability == false && (
              <div
                ...
                role='alert'
              >
                <p>Vartotojo vardas jau yra naudojamas.</p>
              </div>
            )}
              ...
              <div className='row detail-form'>
                <div className='input-field col-md-6'>
                  <label
                    ...
                    className=' required'
                  >
                    Vardas<span className='star'>&#160;*</span>
                  </label>
                  <input
                    type='text'
                    name='firstName'
                ...
                <div className='input-field col-md-6'>
                  <label
                    ...
                    className='required'
                  >
                    Pavardė<span className='star'>&#160;*</span>
                  </label>
                  <input
                    type='text'
                    name='lastName'
                ...
                <div className='input-field col-md-6'>
                  <label id='email-lbl' htmlFor='email' className=' requir'>
                    Elektroninis paštas <span className='star'>&#160;*</span>
                  </label>
                  <input
                    type='text'
                    name='email'
                ...
                <div className='input-field col-md-6'>
                  <label id='country-lbl' className='requir active'>
                    Šalis<span className='star'>&#160;*</span>
                  </label>
                  <select
                    id='country'
                    name='country'
                  ...
                  >
                    <option defaultValue>Select Šalis</option>
                    <CountryOptions />
                  </select>
                  {this.validator.message(
                    'country',
                ...
                <div className='input-field col-md-2'>
                  <label id='countryCode-lbl' className='requir active'>
                    Šalies kodas(+)<span className='star'>&#160;*</span>
                  </label>
                  <select
                    id='countryCode'
                    name='countryCode'
                ...
                <div className='col-md-4 input-field '>
                  <label id='phone-lbl' htmlFor='phone' className=' required'>
                    Telefono numeris<span className='star'>&#160;*</span>
                  </label>
                  <input
                    type='text'
                    name='phone'
                ...
                <div className='col-md-6 input-field '>
                  <label
                    ...
                    className=' required'
                  >
                    Adresas<span className='star'>&#160;*</span>
                  </label>
                  <input
                    type='text'
                    name='address'
                ...
                <div className='input-field col-md-6'>
                  <label id='city-lbl' htmlFor='city' className='required'>
                    Miestas<span className='star'>&#160;*</span>
                  </label>
                  <input
                    type='text'
                    name='city'
                ...
                <div className='input-field col-md-6'>
                  <label id='zip-lbl' fohtmlfor='zip' className=' required'>
                    Pašto kodas<span className='star'>&#160;*</span>
                  </label>
                  <input
                    type='text'
                    name='zip'
                ...
                <div className='input-field col-md-6'>
                  <label
                    ...
                    className=' required'
                  >
                    Vartotojo vardas<span className='star'>&#160;*</span>
                  </label>
                  <input
                    type='text'
                    name='username'
                ...
                <div className='input-field col-md-6'>
                  <label
                    ...
                    className=' required'
                  >
                    Slaptažodis<span className='star'>&#160;*</span>
                  </label>
                  <input
                    type='password'
                    name='password'
                  ...
                  <div className=''>
                    ...
                    <div className='checkbox'>
                      ...
                      <label htmlFor='newslatter'>
                        Norėčiau gauti kassavaitinius naujienlaiškius
                      </label>
                    </div>
                  </div>
                </div>
...
export default BuyCourseFormLanguage;
