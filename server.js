...
const httpPort = 80;
var credentials = {
  key: fs.readFileSync('/etc/apache2/ssl/1/sattvaconnect.com.key'),
  cert: fs.readFileSync('/etc/apache2/ssl/1/59f99ab598ffb1f3.crt'),
  ca: fs.readFileSync('/etc/apache2/ssl/1/gd_bundle-g2-g1.crt'),
};
