  ...
  return (
    <div>
      ...
      <Link href={`/blog/${posts.slug}`}>
        <a>
        <div className='card-course-img blog-card-img left-0'>
        ...
        <Link href={`/blog/${posts.slug}`}>
          ...
          <div className="card-ft">
            ...
            <h5>{`Publish date - ${moment(posts.schdedule_date).format("DD-MM-YYYY")}`}</h5>
            </div>
            <div className="card-ft-icon mt-3">  
            <FacebookShareButton 
                url={Constants.SITE_URL + `/blog/${posts.slug}`}
                quote={posts.title}
