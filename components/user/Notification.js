...
const Notification = (user) => {
  ...
  return (
    <div>
      ...
      <div className="mt-3">
        <h3 className='revamp-blog-title'>Notification</h3>
      </div>
      <form onSubmit={sendPreference}>
        <div className="row mb-5 formCheck checbox-position">
          ...
          <div className="col-lg-6 col-md-6 col-sm-6">
            <div className="container  mt-3">
              ...
              <div class="form-check">
                ...
                <label htmlFor="1" className="form-check-label revamp-para-small">Alerts about your card expiration and membership renewal or cancellation.</label>
              </div>
            </div>
          </div>
          ...
          <div className="col-lg-6 col-md-6 col-sm-6">
            <div className="container  mt-3">
              ...
              <div class="form-check">
                ...
                <label htmlFor="2" className="form-check-label revamp-para-small">Be alerted about upcoming and ongoing Live Classes.</label>
              </div>
            </div>
          </div>
          ...
          <div className="col-lg-6 col-md-6 col-sm-6">
            <div className="container  mt-5">
              ...
              <div class="form-check">
                ...
                <label htmlFor="3" className="form-check-label revamp-para-small">Purchase a course or be alerted about new course offerings.</label>
              </div>
            </div>
          </div>
          ...
          <div className="col-lg-6 col-md-6 col-sm-6">
            <div className="container  mt-5">
              ...
              <div class="form-check">
                ...
                <label htmlFor="4" className="form-check-label revamp-para-small">Be alerted about new and updated series.</label>
              </div>
            </div>
          </div>
          ...
          <div className="col-lg-6 col-md-6 col-sm-6">
            <div className="container  mt-5">
              ...
              <div class="form-check">
                ...
                <label htmlFor="5" className="form-check-label revamp-para-small">Be updated about new videos.</label>
              </div>
            </div>
          </div>
          ...
          <div className="col-lg-6 col-md-6 col-sm-6">
            <div className="container  mt-5">
              ...
              <div class="form-check">
                ...
                <label htmlFor="6" className="form-check-label revamp-para-small">Be updated about your Hari Om posts.</label>
              </div>
            </div>
          </div>
