  ...
  return (
    <Layout>
      <Head>
        ...
        <link rel="canonical" href=" https://www.sattvaconnect.com/privacy-policy" />
      </Head>
      <div className='light-purplebg'>
        <main>
          <section className='sec sec-inabout  sec-list'>
            <div class='container'>
              <h4 className='revamp-subtitle mb-5'>Privacy Policy</h4>
              <div
              ...
              <p className='sub-text'>For EEA Residents:</p>
              <p>
              ...
              <p className='mt-5'>
                ...
                2245 Karen Drive<br></br> Salem, Virginia 24153
                <br></br> Email:&nbsp;&nbsp;info@sattvaconnect.com
              </p>
              <p>&nbsp;</p>
              <p>&nbsp;</p> */}
            </div>
