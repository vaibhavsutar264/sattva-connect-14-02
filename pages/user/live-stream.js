              ...
              <div className='container'>
                <div className='row'>
                  <div className='col-md-12 text-center'>
                    <h1 className='revamp-heading mb-5'>Live Studio</h1>
                    ...
                    <div className='stream-btns'>
                      ...
                      {this.state.hasSubscription == 0 ? (
                        ...
                        <Link href='/user/join-live-viewer'>
                          <a className='btn btn-sm mr-2 alt-btn'>Join Live Studio</a>
                        </Link>
                      )}
                ...
                <div className='class-block my-0 border-0'>
                  <div className='flex-live'>
                    ...
                    <div class="searchbar-form-live py-3">
                      ...
                      <button onClick={this.handleSearch} class="btn btn-sm min-w-100">Search</button>
                    </div>
                  </div>
                  <div className='row'>
