        ...
        <main className='admin-content'>
          <section className='sec sec-explore pb-0'>
            <div className='container'>
              <h4 className=' mb-md-5 mb-4 revamp-subheading'>Browse By Style</h4>
              <div className='row'>
          ...
          <section className='sec sec-style sec-desktop'>
            <div className='container'>
              <div className='class-block mt-0'>
                <h4 className='revamp-subheading'>Asana Lab</h4>
                <div className='row'>
              ...
              <div className='class-block'>
                <h4 className='revamp-subheading'>Pranayama Lab</h4>
                <div className='row'>
              ...
              <div className='class-block'>
                <h4 className='revamp-subheading'>Kriya Lab</h4>
                <div className='row'>
              ...
              <div className='class-block'>
                <h4 className='revamp-subheading'>Mantra Lab</h4>
                <div className='row'>
              ...
              <div className='class-block'>
                <h4 className='revamp-subheading'>Newly Added Videos</h4>
                <div className='row'>
              ...
              <div className='class-block mb-0'>
                <h4 className='revamp-subheading'>My courses</h4>
                <div className='row'>
              ...
              <div className='class-block mb-0'>
                <h4 className='revamp-subheading'>Other Featured Course Available</h4>
                <div className='row'>
