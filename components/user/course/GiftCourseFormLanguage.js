  ...
  async onSubmit(e) {
    ...
    CourseServices.giftCourseWithRegistration(userDetail)
      .then((res) => {
        ...
        Router.push(Constants.SITE_URL + '/user/course-buy-success-language');
        ...
        >
          <div className='card p-4 d-block'>
            <div className='customer-support p-0'>
              <h4 className='revamp-subtitle'>Išsami imtuvo informacija</h4>
              ...
              <div className='row detail-form'>
                ...
                <div className='col-md-12'>
                  <h4 className='mt-3 revamp-subtitle'>Apmokėjimo duomenys</h4>
                  {clientId ? (
                    <DropIn
                      options={{
              ...
              <div className='input-field text-right'>
                {/* <button className="btn btn-lg" data-toggle="modal" data-target="#certificateModal" data-backdrop="static" data-keyboard="false">Preview</button> */}
