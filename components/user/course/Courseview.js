                ...
                <Fade bottom>
                  <div className='row'>
                    <div className='col-xl-6 col-lg-7 col-md-8 col-10 pr-0'>
                      ...
                      ></div>
                      {this.state.courseContent.rating_count > 0 ? '( '+this.state.courseContent.rating_count+' )' : ''}
                      <ReactTooltip
            ...
            <div className='container text-center'>
              ...
              {this.state.courseContent &&
                this.state.courseContent.id == 34 ? (
                  <>
                    <h4 className='text-white'>
                      Begin your journey into the Teachings of the Himalayan Yogis for Full Value Living
                      now!{' '}
                    </h4>
                    <h6 className='text-white'>
                ...
                this.state.courseContent.id == 31 ? (
                  ...
                  {this.state.courseContent &&
                this.state.courseContent.id == 33 ? (
                  <>
                    <h4 className='text-white'>
                    Begin your journey into The Art of Relating now!  {' '}
                    </h4>
                    <h6 className='text-white'>
                    Find your course curriculum below, watch at your own pace and enjoy!
                    </h6>
                ...
                {this.state.courseContent &&
                this.state.courseContent.id == 38 ? (
                  <>
                    <h4 className='text-white'>
                    Begin your journey into Ayurveda: Your Pathway to Self-Healing with Justine Lemos, PhD now!
                    </h4>
                    <h6 className='text-white'>
                    Find your course curriculum below. Watch at your own pace and enjoy!
                    </h6>
                ...
                {this.state.courseContent &&
                this.state.courseContent.id == 39 ? (
                  <>
                    <h4 className='text-white'>
                    Begin your journey into Chandogya Upanishad now!
                    </h4>
                    <h6 className='text-white'>
                    Find your course curriculum below. Watch at your own pace and enjoy!
                    </h6>
              ...
              <div className='progressBarDiv mb-5'>
                ...
                <div className='progressBar'>
                  <div class='progress-box'>
                    ...
                    this.state.courseContent.id == 39 ? (
                      <div class='prog-right-box'>
                        For questions concerning the course content, please send an email to <a href="mailto:info@sattvaconnect.com">info@sattvaconnect.com</a>
                      </div>
                    ) : (
                      ''
                    )}
