...
const blog = () => {
    ...
    const [Acc2022, setAcc2022] = useState(false);
    const [Acc2021, setAcc2021] = useState(false);
    ...
    return (
        <div>
            <Head>
                <link rel="canonical" href="https://www.sattvaconnect.com/blog" />
            </Head>
                ...
                <Layout isHome={true}>
                    <section className='inner-banner about-banner blogBanner' style={{ backgroundImage: `url('/images/banner/blogBanner.jpg' )`, }}>
                        ...
                        <div className='myContainer text-center text-white blog_bannersNew logo_Image'>
                            ...
                            <h1 className='sp-posttitle animated-two fadeInUp sp-animation-2 revamp-signature-heading text-center mb-0'>Yogic Lifestyle Blog</h1>
                                    ...
                                    <div className="col-lg-3 blog-right">
                                        ...
                                        {previousBlog[0] != 0 || previousBlog[1] != 0 || previousBlog[2] != 0 ?
                                            ...
                                            <div class="months-accordian">
                                                ...
                                                <Accordion allowZeroExpanded={true} style={{ border: 'none' }}>
                                                    <AccordionItem>
                                                        <AccordionItemHeading>
                                                            <AccordionItemButton>
                                                                <div className="recent-view-blog">2022</div>
                                                                <svg
                                                ...
                                                {/* <h4 class="revamp-para-small mt-3 accordion__heading pl-3" onClick={() => setAcc2022((prevAcc2022) => !prevAcc2022)}>2022</h4>
                                                <hr /> */}
                                                ...
                                                <Accordion allowZeroExpanded={true} style={{ border: 'none' }}>
                                                    <AccordionItem>
                                                        <AccordionItemHeading>
                                                            <AccordionItemButton>
                                                                <div className="recent-view-blog">2021</div>
                                                                <svg
                                                                    xmlns='http://www.w3.org/2000/svg'
                                                                    x='0'
                                                                    y='0'
                                                ...
                                                {/* <h4 class="revamp-para-small mt-3 accordion__heading pl-3" onClick={() => setAcc2021((prevAcc2021) => !prevAcc2021)}>2021</h4> */}
                                            </div>
                                            : <></>
                                        }
