...
class Header extends Component {
  ...
  componentDidMount = () => {
    ...
    // }
    const userData = getLocalStorageAuth();
    console.log(userData.userDetails.has_subscription)
    if (userData.userDetails.has_subscription === 1) {
      // Router.push('user/me')
      console.log('user/me')
    } else {
      // Router.push('user/my-courses')
      console.log('user/my-courses')
    }
    ...
    console.log(userData.userDetails.created_at);
              ...
              (notification.master_notification && <>
                ...
                <div class="toast show" role="alert" aria-live="assertive" aria-atomic="true">
                  <div class="toast-header">
                    ...
                    <small class="text-muted"><Moment from={notification.local_time}>{notification.user_now}</Moment></small>
