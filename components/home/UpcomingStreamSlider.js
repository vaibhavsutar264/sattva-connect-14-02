            ...
            <section>
                <div className="sec-7 practice_liveTogther">
                    ...
                    <div className="myContainer">
                        <h2 class="wow fadeInUp revamp-heading mb-0">Live Studio</h2>
                    ...
                    <Link href="/upcoming-stream">
                        <button class="courses-btn live wow fadeInUp">
                            <a class='puprleHover_Golden'>View Live Studio Calendar</a>
                        </button>
                    </Link>
                    <Link href={{
                        pathname: '/login',
                        ...
                        <button class="courses-btn live wow fadeInUp">
                            <a class='puprleHover_Golden'>Join Live Studio</a>
                        </button>
                    </Link>
                </div>
            </section>
