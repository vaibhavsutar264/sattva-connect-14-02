...
class CourseLandingPage extends Component {
  ...
  componentDidMount() {
    ...
    if (this.state.affiliateId) {
      ...
      setLocalStorage('affiliate', data);
    }
    ...
    axios
      ...
      .then((res) => {
        ...
        axios
          .get(apiRoute('cms-page-banner/' + res.data.page_id), requestOptions)
          .then((res) => {
  ...
  render() {
    ...
    return (
      <>
        <Head>
          <link rel="canonical" href={`https://www.sattvaconnect.com/course_details/${this.state.courseId}`} />
        </Head>
        ...
        <div className='main coursePage'>
                            ...
                            <>
                              <AccordionItem key={index}>
                                <AccordionItemHeading>
                                  <AccordionItemButton>
                                    <div>
                                      <span>
                                        {item.title}{' '}
                                        {/* this.state.courseContent.id != '10' && this.state.courseContent.id != '31'  && this.state.courseContent.id != '33'  && this.state.courseContent.id != '34' && this.state.courseContent.id != '37'
                                          ? item.description
                                          : ''} */}
                                      </span>
                                    </div>{' '}
                                ...
                                <AccordionItemPanel>
                                  ...
                                  {this.state.courseContent.id == '34' &&
                                    item.description ? (
                                    <>
                                      <p style={{ fontWeight: '500' }}>{item.description}</p>{' '}
                                    </>
                                  ...
                                  {this.state.courseContent.id == '37' &&
                                    item.description ? (
                                    <>
                                      <p style={{ fontWeight: '500' }}>{item.description}</p>{' '}
                                    </>
          ...
          {this.state.courseDetails && this.state.courseDetails[10] ? (
            <div>
              {this.state.courseDetails[10].title ? (
                  ...
                  <div className='container'>
                    {this.state.courseDetails[10].title ? (
                      <h2
                        ...
                        dangerouslySetInnerHTML={{
                          __html: this.state.courseDetails[10].title,
                        }}
                      ></h2>
                    ) : (
                      ''
              ...
              <div ref={this.reviewDiv} id='ratingDiv'>
                <div className='secCourse secReceive secCommunity text-center'>
                  <div className='container'>
                    {this.state.courseContent &&
                      this.state.courseContent.is_in_english == '2' ? (
                      <h2 class='courseHeading mb-sm-5 mb-3 text-center'>
                        Ką sako bendruomenė
                      </h2>
                    ) : (
                      <h2 class='courseHeading mb-sm-5 mb-3 text-center'>
                          ...
                          return (
                            <div class='item' key={index}>
                              <Fade bottom>
                                ...
                                ></p>
                                <h5 className="wow fadeInUp quote-writer-text black-text mt-4 mob-fs-32"> {item.user && item.user.first_name}{' '}
                                  {item.user && item.user.last_name}- <span>{item.user && item.user.country}</span></h5>
                                {/* <p>
                                  <b>
          ...
          {this.state.courseDetails &&
            this.state.courseDetails[11].image != null &&
            this.state.courseContent &&
            this.state.courseContent.id == '10' ? (
            <div
